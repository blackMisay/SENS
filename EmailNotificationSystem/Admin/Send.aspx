<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Send.aspx.vb" Inherits="EmailNotificationSystem.Send" %>
    ...
    <div class="col-md-4">
			...
			<div class="row">
				<div class="form-title" style="text-align:center">
					<span><h1>MAILER</h1></span>
				</div>
			</div>
                <br /><br />
                <div class="sep">
                                <input type="radio" id="control_01" name="select" value="1" onclick="show1();"/>
  <label for="control_01">
    <h4>To All</h4>
    <p>Send an E-mail notification to all. (Faculty, Student, Admins)</p>
  </label>
                            </div>
                 <div class="sep">
  <input type="radio" id="control_02" name="select" value="2"  onclick="show2();"/>
  <label for="control_02">
    <h4>Custom</h4>
    <p>Send an E-mail notification to a specific person.</p>
  </label>
</div>

                <div>
                    <div class="file">
                        <asp:FileUpload ID="FileUpload" runat="server" /><asp:Label ID="Lbl_Template_Status" runat="server" Text=" "></asp:Label>                       
                        </div>
						<label for="usertype">User Type</label>
						<select id="user" runat="server">
			...
			<div class="input-container">
				<div class="row">
					<asp:textbox id="Txt_SendTo" runat="server" textmode="Email" placeholder="Send To"></asp:textbox>
			</div>
                <%--<div class="row">
					<span class="req-input">
						<span class="input-status" data-toggle="tooltip" data-placement="top" title="Please Input Your Email."> </span>
						<asp:textbox id="Recipient" runat="server" textmode="email" placeholder="From"></asp:textbox>
					</span>
				</div>--%>
				
				<div class="row">
					<span class="req-input message-box"></span>
					<asp:TextBox id="message" TextMode="multiline" Columns="100" Rows="5" runat="server" style="resize:none" placeholder="Message"/>
				</div>
